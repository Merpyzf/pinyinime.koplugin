...
| --- | --- | --- | --- | --- |
| [v1.1.1](v1.1.1.md) | 2026-08-16 | v2025.10 | [ZIP](https://github.com/Merpyzf/pinyinime.koplugin/releases/download/v1.1.1/pinyinime.koplugin-v1.1.1.zip) | `c92e89cd523561b6fc4ace82815a0780cd6a9ffd315bfbe19476c350373d883e` |
...
当前最新版为 **v1.1.1**。机器可读的最新版信息见 [index.json](index.json)。
...
```sh
shasum -a 256 pinyinime.koplugin-v1.1.1.zip
```

Windows PowerShell：

```powershell
Get-FileHash .\pinyinime.koplugin-v1.1.1.zip -Algorithm SHA256
```
